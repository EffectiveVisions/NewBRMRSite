            ...
            <div class="row">
                <div class="tg-posts tg-blogposts">
                    <?php if(have_posts()){
                        ...
                        <article class="tg-post tg-verticaltop full">
                            <p><?php esc_attr_e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'efora' ); ?></p>
                        </article>
                    <?php } ?>
                    <!-- Pagination -->
