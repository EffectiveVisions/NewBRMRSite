...
<div id="tg-homebannerslider" class="tg-homebannerslider tg-haslayout">
    <div class="tg-homeslider tg-homebannervtwo tg-haslayout">
        <figure class="item" data-vide-bg="poster: <?php echo esc_url(efora_get_field('background_image_sfive')); ?>" data-vide-options="position: 0% 50%">
            <figcaption>
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="tg-slidercontent">
                                <?php $video_placeholder_sfive = efora_get_field('video_placeholder_sfive');
                                $video_link_sfive = efora_get_field('video_link_sfive');
                                if(!empty($video_placeholder_sfive) && !empty($video_link_sfive)){ ?>
                                <figure class="tg-videobox">
                                    <img src="<?php echo esc_url(efora_get_field('video_placeholder_sfive')); ?>" alt="">
                                    <a class="tg-btnplay" href="<?php echo esc_url(efora_get_field('video_link_sfive')); ?>" data-rel="prettyPhoto[instagram]">
                                        <i class="icon-play3"></i>
                                    </a>
                                </figure>
                                <?php }
                                if(efora_get_field('heading_bparallax') != 'yes'){ ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="tg-findtour tg-findtourvfive">
