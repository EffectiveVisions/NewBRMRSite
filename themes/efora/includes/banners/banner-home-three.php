<?php if(function_exists('is_shop') && is_shop()){
    ...
    (function_exists('is_product_tag') && is_product_tag()) || is_tax('tour_destination') ||
    is_tax('tour_category')){
    $pge_id = get_queried_object();
} else {
    $pge_id = get_the_ID();
}
if(have_rows('add_slide_sthree',$pge_id)){ ?>
    <!--************************************
                    Home Slider Start
            *************************************-->
    <div id="tg-homebannerslider" class="tg-homebannerslider tg-haslayout">
        <div id="tg-homesliderfull" class="tg-homeslider tg-homesliderfull tg-homeslidervthree owl-carousel tg-haslayout">
            <?php while(have_rows('add_slide_sthree',$pge_id)) : the_row();
                ...
                ?>
                <figure class="item" data-vide-bg="poster: <?php echo esc_url($slide_image); ?>" data-vide-options="position: 50% 50%">
                    <figcaption>
                        <div class="container">
                            <div class="row">
        ...
        <div id="tg-homesliderthumbnails" class="tg-homeslider tg-homesliderthumbnails tg-homeslidervthree owl-carousel tg-haslayout">
            <?php while(have_rows('add_slide_sthree',$pge_id)) : the_row();
                ...
                ?>
                <figure class="item" data-vide-bg="poster: <?php echo esc_url($thumbnail_image); ?>" data-vide-options="position: 50% 50%">
                    <figcaption>
                        <div class="tg-slidercontent">
                            <?php if(!empty($heading)){ ?>
                                <h1><?php echo esc_attr($heading); ?></h1>
