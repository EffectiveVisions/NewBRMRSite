...
<section id="featured" class="featureProperty bg-gray py-md-5 py-4 ">
  <div class="container pt-4" ng-controller="PropertyController as pCtrl" ng-cloak>
     <div class="row">
      ...
      <div class="row" ng-init="search.resort_area_id=6458;sortBy='random';availabilitySearch();">
         ...
         <div class="col-md-12 text-center mt-5 mb-4">
            <a href="/search-results/?resort_area_id=6458" class="btn theme-btn rounded-0 text-uppercase btn-ouline-white properties font-weight-light-bold">Search Properties in This Area</a>
         </div>
      </div>
  </div>
</section>
