<?php
/**
 * Template Name: Town Of Seven Devils
...
<section ng-controller="PropertyController as pCtrl" ng-cloak class="position-relative home-banner-section boone-banner-section community-page ">
  ...
  <div class="lazy slider home-banner mb-0 ">
    <?php echo do_shortcode("[wp_owl id='1082']"); ?>
  </div>
<?php endif; ?>
...
<section id="explore" class="trust-pilot my-md-5 my-3 py-4 valle-crucis-exp-sec">
    ...
    <div class="row position-relative img-bar-line  mx-md-0 mx-3 ">
        <?php $count = 0; foreach($explore_images as $explore_image) { ?>
          <div class="col-md-3 col-sm-6 col-12 px-md-0  pl-md-0 pr-md-1 valle-crucis-exp-sec-mob">
                <figure class="mb-0 blog-image position-relative overflow-h w-100"><img datasrc="<?php echo $explore_image['image']['url']; ?>" class="object-fit h-100 w-100" lazy-load alt="" />
...
<section id="featured" class="featureProperty theme-bg-color py-md-5 py-4">
  <div class="container" ng-controller="PropertyController as pCtrl" ng-cloak>
     <div class="row">
      ...
      <div class="row" ng-init="search.resort_area_id='6461'; sortBy='random'; availabilitySearch();">
         ...
         <div class="col-md-12 text-center mt-5 mb-4">
            <a href="/search-results/?resort_area_id=6461" class="btn btn-outline-dark text-uppercase btn-ouline-white properties font-weight-light-bold">Search All Properties in This Area</a>
         </div>
      </div>
  </div>
</section>
...
<script>
      jQuery(document).ready(function(){
        ...
        jQuery(".topmenu").children("a").html("Discover Seven Devils");
