...
<section id="featured" class="featureProperty theme-bg-color py-md-5 py-4">
  <div class="container" ng-controller="PropertyController as pCtrl" ng-cloak>
     <div class="row">
      ...
      <div class="row" ng-init="search.resort_area_id='12944';sortBy='random';availabilitySearch();">
         ...
         <div class="col-md-12 text-center mt-5 mb-4">
            <a href="/search-results/?resort_area_id=12944" class="btn btn-outline-dark text-uppercase btn-ouline-white properties font-weight-light-bold">Search All properties</a>
         </div>
      </div>
  </div>
</section>
