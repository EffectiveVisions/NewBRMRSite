...
<section class="heading blogheading">
	<div class="img d-flex align-items-center justify-content-center banner-title-bg" style="background-image:url('<?php echo $img; ?>');">
		<h1 class="text-white font-weight-semi-bold mb-0"><?php echo $page->post_title; ?></h1>
	</div>
</section>

<section  class="trust-pilot my-lg-5 my-4 blogdetail pt-4">
		...
		<div class="row">
			<div class="col-lg-8 col-12 order-lg-1 order-1">
			   <?php
		        ...
		        ?>
				<div class="blogsec pb-lg-5 pb-4">
					<div class="blogimage">
						<a href="<?php echo the_permalink() ?>"><figure class="mb-0 blog-image overflow-h w-100"> 
                           <?php the_post_thumbnail(); ?>
                        </figure></a>
					</div>
					<div class="blogdetail pb-md-0 pb-3">
						<h3 class="font-weight-bold blog-heading mt-lg-5 mt-4 pt-lg-0 pt-2 mb-md-3 mb-4"><a href="<?php echo the_permalink() ?>" class="text-color"><?php the_title(); ?>
						</a></h3>
						<div class="bloginfo d-flex  align-items-center mb-lg-4 pb-lg-3 pb-4">
						...
						<div class="blogdesc">
							 <p class="font-Nunito font-15"><?php echo wp_trim_words( get_the_content(), 55, '...' );?></p>
						</div>
						<div class="socialshare">
							   <ul class="socialshare list-inline mb-1">
	                                ...
	                                <li class="list-inline-item mr-4"><a data-toggle="tooltip" target="_blank" href="https://www.youtube.com/user/blueridgerentals" title="You tube" href=""><i class="icon icon-youtube socialshare-icon"></i></a></li>
	                                <li class="list-inline-item"><a  data-toggle="tooltip"  href="mailto:info@blueridgerentals.com" title="Email" href="javascript:;"><i class="icon icon-email1 socialshare-icon"></i></a></li>
                               </ul>
						</div>
					</div>
         ...
         <div ng-repeat="property in propertiesObj| orderBy: customSorting : sort | filter: priceRange | filter: amenityFilter | filter: amenityFilterOr | filter: bedroomFilter | filter: locationFilter | filter: neighborhoodFilter | filter: viewNameFilter | limitTo: 2" class="col-lg-12 col-sm-12 p-xl-3 px-md-2 px-3 pt-3  d-inline-flex mb-3 mb-md-0">
          <div class="inner-div  d-inline-block w-100">
			...
			<div class="col-12 order-lg-3 order-2  mb-lg-0 mb-5">
				 <div class="pagination d-flex justify-content-center font-16 font-weight-semi-bold text-center mt-3">
