     ...
     <div class="row">
      ...
      <div class="row" ng-init="search.resort_area_id=12875;sortBy='random';availabilitySearch();">
         ...
         <div class="col-md-12 text-center mt-5 mb-sm-4 mb-3">
            <a href="/search-results/?resort_area_id=12875" class="btn theme-btn read-more text-uppercase font-15  py-0 rounded-0
             properties font-weight-light-bold">Search All Properties in This Area</a>
         </div>
      </div>
  </div>
</section>
