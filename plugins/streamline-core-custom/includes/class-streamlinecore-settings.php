...
class StreamlineCore_Settings{
  ...
  static public function get_default_options() {
    $option_arr = array(
      ...
      'enable_slider_image'               => 0, // checkbox
      'phone'                             => '', // phone
      ...
      'property_neighborhood_id'          => 0, // Select
      ...
      'property_slider_controls'          => 'thumblist', // select (Thumblist)
      ...
      'thankyou_content'                  => '<table class="table table-bordered text-left bg-white w-100">
                                                <tr>
      ...
      'use_recent_units'                  => 0, // checkbox
      'use_compare'                       => 0, // checkbox
      ...
      'checkout_notes'                    => 0, //checkbox
      'property_use_promocode'            => 0, //checkbox
      'property_hide_tooltips'            => 0, //checkbox
      'do_not_verify_zip_code'            => 0, //checkbox
      'max_length_stay'                   => 0, //input
      'group_expected_charges'            => 0, //checkbox
      'select_nr_months_calendar'         => 3, //select,
      'inquiry_only_from'                 => '', //text
      'inquiry_only_to'                   => '', //text
      'include_enabled_optional_fees'     => 0, //checkbox
    );
