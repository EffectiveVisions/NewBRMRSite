          ...
          <div class="row">
            <div class="col-md-12">
              <div class="c-property-listings listings_wrapper_box row" ng-init="limit = searchSettings.propertyPagination">
                <div class="restprolisting" ng-repeat="property in propertiesObj| orderBy: customSorting : sort | filter: priceRange | filter: amenityFilter | filter: amenityFilterOr | filter: bedroomFilter | filter: locationFilter | filter: neighborhoodFilter | filter: viewNameFilter | limitTo: limit as results">
              ...
              <?php if($search_layout == 5): ?>
                <div class="row list-container-wrapper" ng-init="limit = searchSettings.propertyPagination" style="display:none">
                    <div class="restprolisting1" ng-repeat="property in propertiesObj | orderBy: customSorting : sort | filter: priceRange | filter: amenityFilter | filter: amenityFilterOr | filter: bedroomFilter | filter: locationFilter | filter: neighborhoodFilter | filter: viewNameFilter | limitTo: limit as results">
                        <?php
