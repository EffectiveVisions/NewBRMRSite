<div class="panel panel-info">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="<?php echo StreamlineCore_Settings::get_option_name() ?>[search_layout]"
                        ...
                        <option
                            value="5"<?php if (isset($option_arr['search_layout']) && $option_arr['search_layout'] == '5') : ?> selected="selected"<?php endif; ?>><?php _e('Premium Template', 'streamline-core') ?></option>
                        <option
                            value="6"<?php if (isset($option_arr['search_layout']) && $option_arr['search_layout'] == '6') : ?> selected="selected"<?php endif; ?>><?php _e('Las Olas', 'streamline-core') ?></option>
                        <option
                            value="9"<?php if (isset($option_arr['search_layout']) && $option_arr['search_layout'] == '9') : ?> selected="selected"<?php endif; ?>><?php _e('Avangarde Search Template', 'streamline-core') ?></option>
             ...
             <div class="form-group">
                <label for="enable_slider_image" class="col-sm-2 control-label"><?php _e( 'Enable Slider Image', 'streamline-core' ) ?></label>
                <div class="col-sm-10">
                  <input type="checkbox" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[enable_slider_image]" class="control-label" value="1"<?php if ( isset( $option_arr['enable_slider_image'] ) && (int)$option_arr['enable_slider_image'] == 1 ) : ?> checked="checked"<?php endif; ?> />
                </div>
              </div>
             ...
             <div class="form-group">
                <label for="enable_bedroom_range" class="col-sm-2 control-label"><?php _e( 'Enable Bedroom Range', 'streamline-core' ) ?></label>
                <div class="col-sm-10">
                  <input type="checkbox" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[enable_bedroom_range]" class="control-label" value="1"<?php if ( isset( $option_arr['enable_bedroom_range'] ) && (int)$option_arr['enable_bedroom_range'] == 1 ) : ?> checked="checked"<?php endif; ?> />
                </div>
              </div>
             ...
             <div class="form-group">
                <label for="enable_adults_range" class="col-sm-2 control-label"><?php _e( 'Enable Adults Range', 'streamline-core' ) ?></label>
                <div class="col-sm-10">
                  <input type="checkbox" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[enable_adults_range]" class="control-label" value="1"<?php if ( isset( $option_arr['enable_adults_range'] ) && (int)$option_arr['enable_adults_range'] == 1 ) : ?> checked="checked"<?php endif; ?> />
                </div>
              </div>
 ...
 <?php if($current_user->data->user_login == 'Stre@mL1neCore' || $option_arr['search_layout'] == '5'): ?>
<!-- view settings template -->
<div class="panel panel-info">
    <div class="panel-heading">
        <h4 class="panel-title"><?php _e('View Settings Template', 'streamline-core') ?></h4>
    </div>
    <div class="panel-body">
        <div class="form-horizontal">
            
              <div class="form-group">
                <label for="enable_list_view" class="col-sm-2 control-label"><?php _e( 'Enable List View', 'streamline-core' ) ?></label>
                <div class="col-sm-10">
                  <input type="checkbox" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[enable_list_view]" class="control-label" value="1"<?php if ( isset( $option_arr['enable_list_view'] ) && (int)$option_arr['enable_list_view'] == 1 ) : ?> checked="checked"<?php endif; ?> />
                </div>
              </div>
            
              <div class="form-group">
                <label for="enable_map_view" class="col-sm-2 control-label"><?php _e( 'Enable Map View', 'streamline-core' ) ?></label>
                <div class="col-sm-10">
                  <input type="checkbox" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[enable_map_view]" class="control-label" value="1"<?php if ( isset( $option_arr['enable_map_view'] ) && (int)$option_arr['enable_map_view'] == 1 ) : ?> checked="checked"<?php endif; ?> />
                </div>
              </div>
        </div>
    </div>
...
<div class="panel panel-info">
    <div class="panel-heading">
        <h4 class="panel-title"><?php _e('Sidebar Settings', 'streamline-core') ?></h4>
    </div>
    <div class="panel-body">
        <div class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="checkbox" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[sidebar_sticky]" class="control-label" value="1"<?php if ( isset( $option_arr['sidebar_sticky'] ) && (int)$option_arr['sidebar_sticky'] == 1 ) : ?> checked="checked"<?php endif; ?> />
              </div>
            </div>
            <div class="form-group">
              <label for="sidebar_top_spacing" class="col-sm-2 control-label"><?php _e( 'Top Spacing', 'streamline-core' ) ?></label>
              <div class="col-sm-10">
                <input type="text" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[sidebar_top_spacing]" class="form-control" placeholder="<?php _e( 'Sticky Top Spacing', 'streamline-core' ) ?>" value="<?php echo ( isset( $option_arr['sidebar_top_spacing'] ) ? esc_attr( $option_arr['sidebar_top_spacing'] ) : '' ) ?>" />
              </div>
            </div>
            <div class="form-group">
              <label for="<?php echo StreamlineCore_Settings::get_option_name() ?>[sidebar_bottom_spacing]" class="col-sm-2 control-label"><?php _e( 'Bottom Spacing', 'streamline-core' ) ?></label>
              <div class="col-sm-10">
                <input type="text" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[sidebar_bottom_spacing]" class="form-control" placeholder="<?php _e( 'Sticky Bottom Spacing', 'streamline-core' ) ?>" value="<?php echo ( isset( $option_arr['sidebar_bottom_spacing'] ) ? esc_attr( $option_arr['sidebar_bottom_spacing'] ) : '' ) ?>" />
              </div>
            </div>
        </div>
    </div>
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <?php $neighborhood_arr = StreamlineCore_Wrapper::get_neighborhoods(); ?>
                <label for="property_neighborhood_id"
                       class="col-sm-2 control-label"><?php _e('You can select just one neighborhood:', 'streamline-core') ?></label>

                <div class="col-sm-10">
                    <select name="<?php echo StreamlineCore_Settings::get_option_name() ?>[property_neighborhood_id]"
                            class="form-control">
                        <option value="0">All</option>
                        <?php if (is_array($neighborhood_arr) && sizeof($neighborhood_arr)) : ?>
                            <?php foreach ($neighborhood_arr as $neighborhood) : ?>
                                <option
                                    value="<?php echo $neighborhood->id ?>"<?php if (isset($option_arr['property_neighborhood_id']) && $option_arr['property_neighborhood_id'] == $neighborhood->id) : ?> selected="selected"<?php endif; ?>><?php echo $neighborhood->name ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
                </div>
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <div class="form-horizontal">
            ...
            <div class="form-group">
              <label for="select_load_units" class="col-sm-2 control-label"><?php _e( 'Select How To Load Units', 'streamline-core' ) ?></label>
                <div class="col-sm-10">
                    <select name="<?php echo StreamlineCore_Settings::get_option_name() ?>[select_load_units]" class="form-control">
                      <option value="0" <?php if ( isset( $option_arr['select_load_units'] ) && (int)$option_arr['select_load_units'] == 0 ) : ?> selected="selected"<?php endif; ?>><?php _e( 'Show More Button', 'streamline-core' ) ?></option>
                      <option value="1" <?php if ( isset( $option_arr['select_load_units'] ) && (int)$option_arr['select_load_units'] == 1 ) : ?> selected="selected"<?php endif; ?>><?php _e( 'Load Units on Scroll', 'streamline-core' ) ?></option>
                    </select>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="<?php echo StreamlineCore_Settings::get_option_name() ?>[resortpro_default_filter]"
                        ...
                        <option
                            value="occupants"<?php if (isset($option_arr['resortpro_default_filter']) && $option_arr['resortpro_default_filter'] == 'occupants') : ?> selected="selected"<?php endif; ?>><?php _e('Occupants (high to low)', 'streamline-core') ?></option>
                        <option
                            value="occupants_low"<?php if (isset($option_arr['resortpro_default_filter']) && $option_arr['resortpro_default_filter'] == 'occupants_low') : ?> selected="selected"<?php endif; ?>><?php _e('Occupants (low to high)', 'streamline-core') ?></option>
                        <option
                        ...
                        <option
                            value="bedrooms_number_low"<?php if (isset($option_arr['resortpro_default_filter']) && $option_arr['resortpro_default_filter'] == 'bedrooms_number_low') : ?> selected="selected"<?php endif; ?>><?php _e('Bedrooms (low to high)', 'streamline-core') ?></option>
                        <option
