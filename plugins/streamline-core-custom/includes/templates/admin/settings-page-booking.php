  ...
  <div class="panel-body">
    <div class="form-horizontal">
      <div class="form-group">
        <label for="property_use_html" class="col-sm-2 control-label"><?php _e( 'Enable booking', 'streamline-core' ) ?></label>
        <div class="col-sm-10">
      ...
      <div class="form-group">
        <label for="property_use_html" class="col-sm-2 control-label"><?php _e( 'Inquiry Only Period', 'streamline-core' ) ?></label>
        <div class="col-sm-10">
          <div class="row">
            <div class="col-sm-3"><input type="text" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[inquiry_only_from]" class="form-control inquiry-from" placeholder="<?php _e( 'From', 'streamline-core' ) ?>" value="<?php echo ( isset( $option_arr['inquiry_only_from'] ) ? esc_attr( $option_arr['inquiry_only_from'] ) : '' ) ?>" /></div>
            <div class="col-sm-3"><input type="text" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[inquiry_only_to]" class="form-control inquiry-to" placeholder="<?php _e( 'To', 'streamline-core' ) ?>" value="<?php echo ( isset( $option_arr['inquiry_only_to'] ) ? esc_attr( $option_arr['inquiry_only_to'] ) : '' ) ?>" /></div>
          </div>
        </div>
      </div>
...
<div class="panel panel-info">
  ...
  <div class="panel-body">
    <div class="form-horizontal">
      ...
      <div class="form-group">
        <label for="do_not_verify_zip_code" class="col-sm-2 control-label"><?php _e( 'Allow international zip codes', 'streamline-core' ) ?></label>
        <div class="col-sm-10">
          <input type="checkbox" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[do_not_verify_zip_code]" class="form-control" value="1"<?php if ( isset( $option_arr['do_not_verify_zip_code'] ) && (int)$option_arr['do_not_verify_zip_code'] == 1 ) : ?> checked="checked"<?php endif; ?> />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="panel-body">
    <div class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[inquiry_checkin_label]" class="form-control" placeholder="<?php _e( 'Label to show for checkin', 'streamline-core' ) ?>" value="<?php echo ( isset( $option_arr['inquiry_checkin_label'] ) ? esc_attr( $option_arr['inquiry_checkin_label'] ) : '' ) ?>" />
        </div>
        <div class="col-sm-5">
...
<div class="panel panel-info">
  <div class="panel-heading">
    <h4 class="panel-title"><?php _e( 'Restrict Bookings', 'streamline-core' ) ?></h4>
  </div>
  <div class="panel-body">
    <div class="form-horizontal">
      <div class="form-group">
      ...
      <div class="form-group">
          <label for="lm_booking_days" class="col-sm-2 control-label">
            <?php _e( 'Maximum length of stay', 'streamline-core' ) ?>
          </label>
          <div class="col-sm-10">
            <?php echo ResortPro::dropdown( StreamlineCore_Settings::get_option_name() . '[max_length_stay]', array_combine( range( 0, 100 ), range( 0, 100 ) ), ( isset( $option_arr['max_length_stay'] ) ? $option_arr['max_length_stay'] : 0 ) ) ?>
          </div>
      </div>
    </div>
  </div>
