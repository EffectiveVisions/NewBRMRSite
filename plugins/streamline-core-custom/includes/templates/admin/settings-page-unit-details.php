<div class="panel panel-info">
  ...
  <div class="panel-body">
    <div class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <select name="<?php echo StreamlineCore_Settings::get_option_name() ?>[unit_layout]" class="form-control">
            ...
            <option value="4"<?php if ( isset( $option_arr['unit_layout'] ) && (int)$option_arr['unit_layout'] == 4 ) : ?> selected="selected"<?php endif; ?>><?php _e( 'Premium Property Page (One Page Checkout)', 'streamline-core' ) ?></option>
            <option value="5"<?php if ( isset( $option_arr['unit_layout'] ) && (int)$option_arr['unit_layout'] == 5 ) : ?> selected="selected"<?php endif; ?>><?php _e( 'Las Olas', 'streamline-core' ) ?></option>
            <option value="6"<?php if ( isset( $option_arr['unit_layout'] ) && (int)$option_arr['unit_layout'] == 6 ) : ?> selected="selected"<?php endif; ?>><?php _e( 'Avangarde Detail Template', 'streamline-core' ) ?></option>
            
          </select>
        </div>
      </div>
      <div class="form-group">
        <label for="property_use_promocode" class="col-sm-2 control-label"><?php _e( 'Add promo code to details page', 'streamline-core' ) ?></label>
        <div class="col-sm-10">
          <input type="checkbox" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[property_use_promocode]" class="form-control" value="1"<?php if ( isset( $option_arr['property_use_promocode'] ) && (int)$option_arr['property_use_promocode'] == 1 ) : ?> checked="checked"<?php endif; ?> />
        </div>
      </div>
      <div class="form-group">
        <label for="property_hide_tooltips" class="col-sm-2 control-label"><?php _e( 'Hide price in calendar tooltip', 'streamline-core' ) ?></label>
        <div class="col-sm-10">
          <input type="checkbox" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[property_hide_tooltips]" class="form-control" value="1"<?php if ( isset( $option_arr['property_hide_tooltips'] ) && (int)$option_arr['property_hide_tooltips'] == 1 ) : ?> checked="checked"<?php endif; ?> />
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="enable_book_from_lightbox" class="col-sm-2 control-label"><?php _e( 'Enable Book from Lightbox', 'streamline-core' ) ?></label>
        <div class="col-sm-10">
          <input type="checkbox" name="<?php echo StreamlineCore_Settings::get_option_name() ?>[enable_book_from_lightbox]" class="form-control" value="1"<?php if ( isset( $option_arr['enable_book_from_lightbox'] ) && (int)$option_arr['enable_book_from_lightbox'] == 1 ) : ?> checked="checked"<?php endif; ?> />
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="property_slider_controls" class="col-sm-2 control-label"><?php _e( 'Select Slider Controls', 'streamline-core' ) ?></label>
        <div class="col-sm-10">
          <select name="<?php echo StreamlineCore_Settings::get_option_name() ?>[property_slider_controls]" class="form-control">
            <option value="thumblist"<?php if ( isset( $option_arr['property_slider_controls'] ) && $option_arr['property_slider_controls'] === 'thumblist' ) : ?> selected="selected"<?php endif; ?>><?php _e( 'Thumblist', 'streamline-core' ) ?></option>
            <option value="bullets"<?php if ( isset( $option_arr['property_slider_controls'] ) && $option_arr['property_slider_controls'] === 'bullets' ) : ?> selected="selected"<?php endif; ?>><?php _e( 'Bullets', 'streamline-core' ) ?></option>
            <option value="none"<?php if ( isset( $option_arr['property_slider_controls'] ) && $option_arr['property_slider_controls'] === 'none' ) : ?> selected="selected"<?php endif; ?>><?php _e( 'None', 'streamline-core' ) ?></option>
          </select>
        </div>
      </div>
      <div class="form-group">
      ...
      <?php if($current_user->data->user_login == 'Stre@mL1neCore' || $option_arr['select_nr_months_calendar'] == '3' || $option_arr['select_nr_months_calendar'] == '6' || $option_arr['select_nr_months_calendar'] == '9' || $option_arr['select_nr_months_calendar'] == '12'): ?>
        <div class="form-group">
          <label for="select_nr_months_calendar" class="col-sm-2 control-label"><?php _e( 'Select Numbers of Months on Availability Calendar', 'streamline-core' ) ?></label>
            <div class="col-sm-10">
                <select name="<?php echo StreamlineCore_Settings::get_option_name() ?>[select_nr_months_calendar]" class="form-control">
                  <option value="3" <?php if ( isset( $option_arr['select_nr_months_calendar'] ) && (int)$option_arr['select_nr_months_calendar'] == 3 ) : ?> selected="selected"<?php endif; ?>><?php _e( '3 months', 'streamline-core' ) ?></option>
                  <option value="6" <?php if ( isset( $option_arr['select_nr_months_calendar'] ) && (int)$option_arr['select_nr_months_calendar'] == 6 ) : ?> selected="selected"<?php endif; ?>><?php _e( '6 months', 'streamline-core' ) ?></option>
                  <option value="9" <?php if ( isset( $option_arr['select_nr_months_calendar'] ) && (int)$option_arr['select_nr_months_calendar'] == 9 ) : ?> selected="selected"<?php endif; ?>><?php _e( '9 months', 'streamline-core' ) ?></option>
                  <option value="12" <?php if ( isset( $option_arr['select_nr_months_calendar'] ) && (int)$option_arr['select_nr_months_calendar'] == 12 ) : ?> selected="selected"<?php endif; ?>><?php _e( '12 months', 'streamline-core' ) ?></option>
                </select>
            </div>
        </div>
      <?php endif; ?>
