        ...
        <div class="modal-content">
            <form class="form-horizontal" id="modal_form1"
                ...
                <div class="modal-footer">
                    <button type="button" id="cancelreservation" class="btn btn-default" data-dismiss="modal"><?php _e( 'Cancel', 'streamline-core' ) ?></button>
                    <button ng-click="setNights()" type="button" id="makereservation" class="btn btn-success">
