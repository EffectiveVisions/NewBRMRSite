...
<div id="primary" class="content-area test2" ng-controller="PropertyController as pCtrl">
  <main id="main" class="site-main" role="main" ng-init="initializeData(<?php echo $property['id']; ?>);">
    <div class="row layout-2">
      ...
      <div class="col-lg-8 col-xs-12">
        <div class="c-property-slider c-property-slider--layout-2 c-property-slider--partial-view ms-showcase2-template">
        ...
        <section class="o-section-wrapper row">
          <div class="col-xs-12">
            <div class="c-section-title c-section-title--bordered c-section-title--inline-flex">
              <h3 class="c-section-title__item c-section-title__item--heading"><?php _e( 'About this listing', 'streamline-core' ) ?></h3>

              <?php if ($property['rating_average'] > 0): ?>
                <div class="c-section-title__item c-section-title__item--reviews">

                  <div class="c-star-rating c-star-rating--large text-center">
