...
<div id="checkout-container" class="row content-area" ng-controller="CheckoutController as cCtrl">
  <div ng-init="hash = '<?php echo $hash;?>';referrer_url='<?php echo $checkout_url;?>';unit_id='<?php echo $unit_id; ?>';location_id='<?php echo $location_id; ?>';condo_type_id='<?php echo $condo_type_id; ?>'">
    <main id="main" class="site-main" role="main" ng-init="initCheckout()">
      ...
      <?php if  ($online_bookings ==  0 && empty($hash)): ?>          
        <div class="col-md-12">
          <div class="alert alert-danger">
            <p>
      ...
      <?php else: ?>
        ...
        <div class="col-md-12 form-checkout-wrapper" ng-show="!error">
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="form-group col-sm-6">
                              <input type="text" name="fname" placeholder="<?php  _e('First Name',  'streamline-core'); ?>" class="form-control form-icon" ng-model="checkout.fname"
                            ...
                            <div class="form-group col-sm-6">
                              <input type="text" name="lname" class="form-control form-icon" placeholder="<?php _e('Last Name', 'streamline-core'); ?>" ng-model="checkout.lname" ng-change="validateStepOne(checkout)" required>
                              <span class="icon-checkout icon-name"></span>
                          ...
                          <div class="row">
                            <div class="form-group col-sm-6">
                              <input type="email" name="email" class="form-control form-icon" placeholder="<?php  _e('Email', 'streamline-core'); ?>" ng-model="checkout.email"
                                required />
                            ...
                            <div class="form-group col-sm-6">
                              <input type="phone" name="phone" class="form-control form-icon" ng-pattern="/^-?\d*$/" ng-model="checkout.phone" required placeholder="(###) ###-####" />
                          ...
                          <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">                                            
                              <button type="submit" class="btn btn-block btn-green" ng-disabled="!reservationDetails.optional_fees" ng-click="goToStep2(false)">
                                <?php _e('Continue',  'streamline-core'); ?>&nbsp;<i class="glyphicon glyphicon-circle-arrow-right"></i>
                              </button>                                            
                              <?php if  ($pbg_enabled): ?>
                                <div class="row">
                                  <div class="col-md-12">
            ...
            <div class="panel panel-default" ng-show="reservationDetails.optional_fees.length > 0">
              ...
              <div id="step2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                <div class="panel-body panel-step-2">
                  <div class="row flexbox-container css-form">
                          ...
                          <table class="table table-condensed table-hover">
                            ...
                            <tbody>
                              ...
                              <tr ng-repeat="res in reservationDetails.reservation_days" class="breakdown-days-hidden" data-visible="false">
                                <td class="fee-name" ng-bind="res.date"></td>
                                <td class="text-right">
                              ...
                              <tr ng-repeat="reqFee in reservationDetails.required_fees" class="breakdown-taxes-hidden" data-visible="false">
                                <td class="fee-name" ng-bind="reqFee.name"></td>
                                <td class="text-right">
                              ...
                              <tr ng-repeat="optFee in reservationDetails.optional_fees track by $index" ng-if="optFee.active == 1" class="breakdown-taxes-hidden"
                                data-visible="false">
                                <td class="fee-name" ng-bind="optFee.name"></td>
                                <td class="text-right">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="optional_fees_wrapper" ng-if="reservationDetails.optional_fees.length > 0">
                            ...
                            <div ng-repeat="optFee in reservationDetails.optional_fees track by $index">
                                  ...
                                  <div class="row row-fee">                                                  
                                    <div class="col-md-10 col-sm-9 col-xs-8">
                                      <div class="opt-fee">
                                        ...
                                        <label class="opt-fee-name" for="optional-fee-{[optFee.id]}" ng-bind="optFee.name"></label>
                        ...
                        <div class="col-md-12">
                          <div class="row" style="margin-top:10px">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-sm-push-6 col-md-push-6 col-lg-push-6">
                              <div class="form-group">
                                <button type="button" id="btn-step-2" class="btn btn-block btn-green" ng-click="goToStep3()">
                                  <?php _e('Continue',  'streamline-core')  ?>&nbsp;<i class="glyphicon glyphicon-circle-arrow-right"></i>
                                </button>                                            
                              </div>                                            
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-sm-pull-6 col-md-pull-6 col-lg-pull-6">                                            
                              <button type="button" class="btn btn-block btn-default" ng-click="goToStepOne()">
                            ...
                            <table class="table table-hover table-condensed">
                              ...
                              <tbody>
                                ...
                                <tr ng-repeat="tax in reservationDetails.taxes_details track by $index" class="breakdown-taxes-hidden" data-visible="false">
                                  <td class="fee-name" ng-bind="tax.name"></td>
                                  <td class="text-right">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-sm-pull-6 col-md-pull-6 col-lg-pull-6">
                                <div class="form-group">
                                  <button type="button" class="btn btn-block btn-default" ng-click="goToStepTwo()" ng-if="reservationDetails.optional_fees.length > 0">
                                    <i class="glyphicon glyphicon-arrow-left"></i>&nbsp;
                                    <?php _e('Go Back', 'streamline-core')  ?>
                                  </button>
                                  <button type="button" class="btn btn-block btn-default" ng-click="goToStepOne()" ng-if="!reservationDetails.optional_fees.length > 0">
                                    <i class="glyphicon glyphicon-arrow-left"></i>&nbsp;
                                    <?php _e('Go Back', 'streamline-core')  ?>
                                  </button>
                                </div>
