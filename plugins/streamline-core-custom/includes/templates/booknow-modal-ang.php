<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria - labelledby="myModalLabel">
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			...
			<form class="form-horizontal" id="modal_form" action="<?php echo get_permalink(get_page_by_slug('checkout')) ?>" method="post">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="alert alert-{[alert.type]} animate alert-dismissible" role="alert" ng-repeat="alert in alerts">
							<button type="button" class="close" data-dismiss="alert" aria-label="<?php _e( 'Close', 'streamline-core' ) ?>">
								<span aria-hidden="true">&times;</span>
							</button>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="sd" class="col-sm-5 control-label">
									<?php _e( 'Check in:', 'streamline-core' ) ?>
								</label>

								<div class="col-sm-7">
									<input type="text" ng-model="modal_checkin" id="modal_start_date" name="book_start_date" class="form-control" show-days="myShowDaysFunction(date)"
									  update-price="updatePricePopupCalendar()" modalcheckin readonly="readonly" data-min-stay="<?php echo $min_stay ?>"
							...
							<div class="form-group" id="group-enddate" ng-show="!showDays">
								<label for="ed" class="col-sm-5 control-label">
									<?php _e( 'Check out:', 'streamline-core' ) ?>
								</label>
								<div class="col-sm-7">
									<input type="text" ng-model="modal_checkout" id="modal_end_date" name="book_end_date" class="form-control" show-days="myShowDaysFunction(date)"
									  update-price="updatePricePopupCalendar()" modalcheckout readonly="readonly" data-min-stay="<?php echo $min_stay ?>"
									  data-checkin-days="<?php echo $checkin_days ?>" />
								</div>
							</div>
							<div class="form-group" id="group-days" ng-show="showDays">
								<label for="modal_days" class="col-sm-5 control-label">
									<?php _e( 'Nights:', 'streamline-core' ) ?>
								</label>
								<div class="col-sm-7">
									<div class="c-select-list form-control">
										<select id="modal_days" ng-model="modal_nights" ng-change="setNights()">
											<option value="">
												<?php _e( 'Select # of nights', 'streamline-core' ) ?>
											</option>
											<?php for($i = 1; $i <= 60; $i++): ?>
...
+									<!-- /.c-select-list -->
							...
							<div class="form-group" ng-show="!showDays" ng-init="modal_occupants='1'">
								<label class="col-sm-4 control-label" for="modal_occupants">
									<?php _e( 'Adults', 'streamline-core' ) ?>
								</label>
								<div class="col-sm-8">
									<div class="c-select-list form-control">
										<select id="modal_occupants" ng-model="modal_occupants" ng-change="updatePricePopupCalendar();" name="book_occupants">
											<?php
											$max_adults = 10;
...
+									<!-- /.c-select-list -->
							...
							<div class="form-group" ng-show="!showDays" ng-init="modal_occupants_small='0'">
								<label class="col-sm-4 control-label" for="modal_occupants_small">
									<?php _e( 'Children', 'streamline-core' ) ?>
								</label>
								<div class="col-sm-8">
									<div class="c-select-list form-control">
										<select id="modal_occupants_small" name="book_occupants_small" ng-model="modal_occupants_small" ng-change="updatePricePopupCalendar();">
											<?php
...
+									<!-- /.c-select-list -->
							...
							<div class="form-group" ng-show="!showDays" ng-init="modal_pets='0'">
								<label class="col-sm-4 control-label" for="modal_pets">
...
+									<!-- /.c-select-list -->
						...
						<div class="col-md-6">
							<table ng-show="modal_total_reservation > 0" class="table table-stripped table-bordered table-condensed">
								...
								<tr style="border-top:solid 2px #333">
									<td>
										<?php _e( 'Subtotal', 'streamline-core' ) ?>
									</td>
