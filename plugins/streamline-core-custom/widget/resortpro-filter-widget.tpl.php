...
<div class="c-filter-widget filter-widget">
    ...
    <form method="post" class="form c-filter-widget__form" id="resortpro-widget-form" ng-submit="availabilitySearch(search)" ng-init="plus='<?php echo $instance['number_bedrooms-plus']; ?>'">
